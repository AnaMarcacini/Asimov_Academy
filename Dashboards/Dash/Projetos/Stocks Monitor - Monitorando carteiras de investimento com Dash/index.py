...
try:    # caso exista, ler infos
    ...
    df_book = pd.DataFrame(columns=['date', 'preco', 'tipo', 'ativo', 'exchange', 'vol', 'valor_total'])# cria o dataframe do zero
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            ...
            ],id="page-content"),# Essa linha será alterada dinamicamente
        ])
    ])
], fluid=True)
...
# Atualiza a Ultima coluna de acordo com o estado do menu
@app.callback(
