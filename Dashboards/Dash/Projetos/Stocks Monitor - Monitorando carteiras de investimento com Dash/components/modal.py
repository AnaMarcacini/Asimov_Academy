...
layout = dbc.Modal([#pop up
    ...
    dbc.ModalBody([
        dbc.Row([
            ...
            dbc.Col([
                dbc.Input(id="preco_ativo", placeholder="Preço (R$)", type='number', min=0, step=0.01) # setinha incrementa ou desencrementa de 0,01 em 0,01 
            ])
        ]),
        dbc.Row([
            dbc.Col([
        ...
        dbc.Row([
            dbc.Col([
                dbc.RadioItems(id='compra_venda_radio', options=[{"label": "Compra", "value": 'Compra'}, {"label": "Venda", "value": 'Venda'}], value='Compra'), # padrão compra 
