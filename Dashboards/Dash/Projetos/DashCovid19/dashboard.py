...
# df_states = df[(~df["estado"].isna()) & (df["codmun"].isna())] # estado sempre que o estado  não é nulo e codmun é nulo
...
fig = px.choropleth_mapbox(df_states_, locations="estado",# casar com o estado
    ...
    hover_data={"casosAcumulado": True, "casosNovos": True, "obitosNovos": True, "estado": True}#o que mostra quando passar o mouse
    )
fig.update_layout(
            ...
            dbc.Col([
                    ...
                    html.Div([
                        ...
                        dcc.Dropdown(
                                        ...
                                        value="casosNovos",#por padrão casos novos
                ...
                [
                    dcc.Loading(
                        ...
                        children=[dcc.Graph(id="choropleth-map", figure=fig, 
                            style={'height': '100vh', 'margin-right': '10px'})],# 100% da visão horizontal
                    ),
                ], md=7),
            ])
    ], fluid=True, 
