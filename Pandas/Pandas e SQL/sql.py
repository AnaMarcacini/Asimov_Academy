...
df_data.to_sql('data', conn, index_label='index_name')#passar dados do data para sql


c = conn.cursor()
c.execute('CREATE TABLE products (product_id, product_name, price)')
conn.commit()#alguns comandos nescessitam do commit para atualizar o bd nesse caso não é necessário
