...
imagem.save('imagensGeradas/image_save.png')
# Provando que o formato foi alterado
im_aux = Image.open('imagensGeradas/image_save.png')
im_aux.format
...
imagem.save('imagensGeradas/thumbnail.jpg')
im_aux = Image.open('imagensGeradas/thumbnail.jpg')
im_aux.show()
...
mascara.save('imagensGeradas/mask.jpg', quality=95)

imagem.paste(imagem2, (0, 0), mascara) # Colando a imagem com a mascara
